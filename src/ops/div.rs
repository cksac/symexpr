...
impl<C, L, R> Clone for Div<C, L, R>
where
    L: SymValue<C> + Clone,
    R: SymValue<C> + Clone,
{
...
impl<C, E, R, LHS, RHS, OUT> std::ops::Div<R> for Sym<LHS, C, E>
where
    C: SymCtx<LHS> + SymCtx<RHS> + SymCtx<OUT>,
    ...
    OUT: Value,
{
    ...
    fn div(self, rhs: R) -> Self::Output {
        Sym::Expr(E::wrap(Div::new(self, rhs)))
    }
}
    ...
    OUT: Value,
{
    ...
    fn div(self, rhs: R) -> Self::Output {
        Sym::Expr(E::wrap(Div::new(self.clone(), rhs)))
    }
}
